// Sexy times suggestion generator
function generateSuggestion(intensity, focus, toys) {
    ...
    const randomIndex = Math.floor(Math.random() * baseSuggestion.length);
    let suggestion = baseSuggestion[randomIndex];
...
document.getElementById('sexyForm').addEventListener('submit', function(e) {
    e.preventDefault();
